const CACHE_NAME='sapporo-shell-v14-maps-import';
const APP_SHELL=['./','./index.html','./manual.html','./sapporo-trip-user-manual.pdf','./style.css?v=12','./pwa.css?v=9','./script.js?v=14','./manifest.webmanifest','./offline.html','./icons/app-icon.svg','./icons/app-icon-192.png','./icons/app-icon-512.png','./icons/apple-touch-icon.png'];
